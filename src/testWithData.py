...
fieldDataFile = './iwCabData/config_10/dataFromSim/down/b25_t90/D_field_down.csv'#'./iwCabData/adrian_data/DATAFIELD_sample.csv'
simDataFile = './iwCabData/config_10/dataFromSim/down/b25_t90/D_sim_down.csv'#'./iwCabData/adrian_data/DATACOMP_sample.csv'
cmbYArgs = [];
ydim = 1;

stanInFileName = './iwCabData/config_10/stan_in/chong_nodelta.stan'
dftModelName = './iwCabData/config_10/stan_compiled/chong_nodelta.pkl'

save_base_dir = './mcmcRes/config_10/fromData' 
