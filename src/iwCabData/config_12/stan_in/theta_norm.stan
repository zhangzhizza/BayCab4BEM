...
model {
	...
	theta[1] ~ normal(0.64, 0.3); //ext wall insul thickness
	theta[2] ~ normal(0.41, 0.3); //mull insul thickness
	theta[3] ~ normal(0.4, 0.3); //piched roof insul thickness
	theta[4] ~ normal(0.2, 0.3); //ext win U
	theta[5] ~ normal(0.1, 0.3); //ext win SHGC
	theta[6] ~ normal(0.6, 0.3); //int mass area
	theta[7] ~ normal(0.6, 0.3); //infil rate
	theta[8] ~ normal(0.7, 0.3); //flat roof insul thickness
	theta[9] ~ normal(0.1, 0.3); //mull surface metal thickness
	theta[10] ~ normal(0.33, 0.3); //zone mixing rate
	theta[11] ~ normal(0.25, 0.3); //low equipment density
	theta[12] ~ normal(0.66, 0.3); //high equipment density
