...
model {
	...
	//}
	theta[1] ~ uniform(0.0, 1.0);
	theta[2] ~ normal(0.41, 0.15);
	theta[3] ~ normal(0.50, 0.15);
	theta[4] ~ uniform(0.0, 1.0);
	theta[5] ~ normal(0.25, 0.15);
	theta[6] ~ normal(0.33, 0.15);
	theta[7] ~ normal(0.57, 0.15);
